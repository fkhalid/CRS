...
code/src/general/%.o: ../code/src/general/%.c
	...
	gcc -g -pg -Wall -D_no_numericalrecipes -I/home/des/camcat/masterdes_exthd1/sec21/NumericalRecipes/2.11/C_211/other -I/home/des/camcat/masterdes_exthd1/sec21/NumericalRecipes/2.11/C_211/recipes -O0 -c -fmessage-length=0 -std=c99 -fopenmp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
