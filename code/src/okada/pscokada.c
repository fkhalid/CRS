...
void pscokada(double x1, double y1, double z1, double strike1, double dip1, double L, double W, double slip_strike, double slip_dip, double x2, double y2, double z2, double *sxx, double *syy, double *szz, double *sxy, double *syz, double *szx, double alpha, double lambda, double mu, double friction) {
...
void pscokada_f(double x1, double y1, double z1, double strike1, double dip1, double L, double W, double slip_strike, double slip_dip, double x2, double y2, double z2, float *sxx, float *syy, float *szz, float *sxy, float *syz, float *szx, double alpha, double lambda, double mu, double friction) {
//strike, dip in radians!
//x is northward, y is eastward, and z is downward//
//float version.
	...
	DC3D(alpha, X, Y, Z, depth, di*RAD2DEG, AL1, AL2, AW1, AW2, DISL1, DISL2, DISL3, &UX, &UY, &UZ, &UXX, &UYX, &UZX, &UXY, &UYY, &UZY, &UXZ, &UYZ, &UZZ, &IRET);
	...
	dum1 = lambda * eii;
	dum2 = 2.0 * mu;
	*sxx = (float) (dum1 + dum2 * strain1);
	*syy = (float) (dum1 + dum2 * strain2);
	*szz = (float) (dum1 + dum2 * strain3);
	*sxy = (float) (       dum2 * strain4);
	*syz = (float) (       dum2 * strain5);
	*szx = (float) (       dum2 * strain6);
